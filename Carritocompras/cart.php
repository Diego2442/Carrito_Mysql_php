<?php
  ...
  if(isset($_SESSION['carrito'])){
    //si existe miramos si esta el producto agregado
    if(isset($_GET['id'])){
    ...
    //si no se crea la variable de sesion
    if(isset($_GET['id'])){
      $nombre = "";
      $precio = "";
      $imagen= "";
              ...
              <table class="table table-bordered">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>Cop <?php echo $arreglocarrito[$i]['Precio']; ?></td>
                    <td>
                    ...
                    <td class="cant<?php echo $arreglocarrito[$i]['Id']; ?>">Cop <?php echo $arreglocarrito[$i]['Precio'] * $arreglocarrito[$i]['Cantidad'];  ?></td>
                    //utilizar cant pegado al código de php o sino no funciona.
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">Cop <?php echo $total; ?> </strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
